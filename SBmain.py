...
class CannotPlaceShip(Error):
    def __str__(self):
        return "Невозможно разместить корабль!"
...
class AI(Player):
    def ask(self):
        ...
        print(f"Противник ходит: {d.x+1} {d.y+1}")
        return d
...
class Game:
    ...
    def greet(self):
        ...
        print(" x - номер по горизонтали  ")
        print(" y - номер по вертикали ")
